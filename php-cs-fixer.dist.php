...
return $config
    ->setRules([
        ...
        'braces_position'               => true,           // part of the 'braces' replacement
        'single_space_around_construct' => true, // part of the 'braces' replacement
        'control_structure_braces'      => true,      // part of the 'braces' replacement
        'statement_indentation'         => true,      // part of the 'braces' replacement
